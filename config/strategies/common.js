...
exports.sortByScore = function(recommendation) {
...
exports.getCosineSimilarityRowVector = function(matrix, index) {
  return matrix.map((rowRelative, i) => {
    return similarity(matrix[index], matrix[i]);
  });
}

exports.getMovieIndexByTitle = function(MOVIES_IN_LIST, query) {
